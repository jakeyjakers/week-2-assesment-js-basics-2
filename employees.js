...
let empOne = new Employee('jess', 'weekday mornigs, weekday afternoons')
...
//CODE HERE
let manager = new Manager('winston', 'shifts: weekday mornings, weekday afternoons', ['cece', 'schmidt'])
